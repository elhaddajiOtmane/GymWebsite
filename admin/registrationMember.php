                        ...
                        <div class="card-body">
                            ...
                            <form action="registrationMember.php" method="POST" onsubmit="return registrationmemberValidation()">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control bg-light" id="firstname" name="firstname" require>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control bg-light" id="middlename" name="middlename" require>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control bg-light" id="lastname" name="lastname" require>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="email" class="form-control bg-light" id="email" name="email" require>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control bg-light" id="caddress" name="caddress" require>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="number" class="form-control bg-light" id="adhar" name="adhar" require>
                                    </div>
                                </div>
