        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                      <h5 class="card-title" style="font-size:20px;"><i class="fas fa-user-plus"></i> Add Members</h5>
                      <a href="registrationMember.php" class="btn btn-primary" style="font-size:15px;">check</a>
                    </div>
                  </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-12">
